import { isDomainDisposable } from "../utils/disposableDomains";
import { Request, Response } from "express";
import { ApiResponseEmail } from "../utils/ApiResponse";

export function ValidateEmail(req: Request, res: Response): Response<ApiResponseEmail> {
    try {
